...
class OTPResendButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final timerText = switch (state) {
      TickingResendState(:final remainingSeconds) => _formatDuration(
        remainingSeconds,
      ),
      ShortCooldownResendState(:final remainingSeconds) => _formatDuration(
        remainingSeconds,
      ),
      LongCooldownResendState(:final remainingSeconds) => _formatDuration(
        remainingSeconds,
      ),
    ...
    final cooldownLine = switch (state) {
      ShortCooldownResendState(:final remainingSeconds) => labels.shortCooldown(
        _formatDuration(remainingSeconds),
      ),
      LongCooldownResendState(:final remainingSeconds) => labels.longCooldown(
        _formatDuration(remainingSeconds),
      ),
      _ => null,
    };
