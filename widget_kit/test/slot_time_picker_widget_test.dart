...
void main() {
      ...
      await tester.pumpWidget(
        _wrap(
          InlineSlotTimePicker(
            ...
            onTimeSlotSelected: (_) {},
            labels:
                const SlotPickerLabels(chooseDatePrompt: 'Pick a date first'),
          ),
        ),
      );
      await tester.pump();
  ...
  group('InlineSlotTimePicker — timeOnly mode', () {
    ...
    testWidgets('shows the no-slots message when there are none',
        (tester) async {
      await tester.pumpWidget(
        _wrap(
          InlineSlotTimePicker(
            ...
            initialSlots: const [],
            labels:
                const SlotPickerLabels(noSlotsMessage: 'Nothing free today'),
          ),
        ),
      );
      await tester.pump();
