      ...
      home: Scaffold(
        body: SingleChildScrollView(
          child: Accordion(
            ...
            items: [
              AccordionItemData(
                  header: const Text('H0'), content: _content('0')),
              AccordionItemData(
                  header: const Text('H1'), content: _content('1')),
            ],
          ),
        ),
      ),
...
void main() {
  group('Accordion', () {
    ...
    testWidgets('tapping a header expands that panel', (tester) async {
      ...
      expect(_panelHeightOf(tester, '0'), greaterThanOrEqualTo(_contentHeight),
    ...
    testWidgets('single-open mode: opening one closes the other',
      ...
      expect(_panelHeightOf(tester, '1'), greaterThanOrEqualTo(_contentHeight),
