...
class CarouselPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Carousel',
      intro:
          'A Riverpod-powered carousel with preset configs, indicators, '
          'overlays and auto-scroll. Items can be images or any widget.',
      sections: [
        DemoSection(
          title: 'Banner preset',
          description:
              'CarouselConfig.banner — a simple swipeable banner with '
              'a dot indicator.',
          ...
          demo: Carousel(config: CarouselConfig.banner, items: _colorSlides()),
          code: '''
Carousel(
  ...
  items: [
    ...
    WidgetCarouselItem(builder: (_) => MySlide()),
        ...
        DemoSection(
          ...
          description:
              'CarouselConfig.hero — larger, auto-scrolling, with an '
              'overlay indicator.',
          demoBackground: false,
          demo: Carousel(config: CarouselConfig.hero, items: _colorSlides()),
...
class _StandaloneIndicatorDemoState extends State<_StandaloneIndicatorDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description:
          'The dot indicator can be used on its own, driven by your '
          'own page state.',
      demo: Column(
