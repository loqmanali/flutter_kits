...
class ContextMenuPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Context Menu',
      intro:
          'Wrap any widget; open a floating, screen-aware menu on tap or '
          'long-press. Supports nested submenus and disabled rows.',
      sections: const [_TapMenuDemo(), _LongPressMenuDemo(), _SubmenuDemo()],
    );
  }
}
...
class _TapMenuDemoState extends State<_TapMenuDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      title: 'Tap to open',
      description:
          'The default trigger is a tap. Each MenuItem has a title, an '
...
class _LongPressMenuDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description:
          'Set trigger: MenuTrigger.longPress for a press-and-hold '
...
class _SubmenuDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description:
          'Give a MenuItem subItems to render it as a submenu trigger '
          'with a chevron.',
      demo: ContextMenu(
        items: [
