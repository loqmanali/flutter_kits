...
class FeedbackPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Feedback',
      intro:
          'States for empty data, errors, in-flight loading, and skeleton '
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              ...
              description:
                  'Shown when a list or screen has no content. Optional '
...
EmptyStateWidget(
  ...
  onAction: () {},
            ...
            DemoSection(
              ...
              description:
                  'A retry-able error panel with a default title and a '
        ...
        DemoGroup(
          ...
          children: [
            const DemoSection(
              ...
              description:
                  'A unified spinner with 30+ styles, including an '
              ...
              demo: Wrap(
                ...
                children: [
                  ...
                  _LabelledLoader(
                    'fadingCircle',
                    LoadingIndicatorType.fadingCircle,
                  ),
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              ...
              description:
                  'Ready-made skeleton placeholders that animate while '
                  'real content loads.',
...
ShimmerLayouts.banner(height: 180)''',
            ...
            DemoSection(
              ...
              description:
                  'Compose custom skeletons from primitive shapes, '
    ...
    return Column(
      ...
      children: [
        SizedBox(
          height: 36,
          width: 36,
          child: Center(child: LoadingIndicator(type: type, size: 30)),
        ),
