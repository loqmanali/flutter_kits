...
class DropdownPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Dropdown Menu',
      intro:
          'A trigger-anchored overlay menu supporting plain items, section '
          'labels, separators, checkboxes and radios.',
      sections: const [_BasicDropdown(), _RichDropdown()],
    );
  }
}
...
class _BasicDropdownState extends State<_BasicDropdown> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description:
          'Tap the trigger to open. Each CustomDropdownItem can carry '
...
class _RichDropdownState extends State<_RichDropdown> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description:
          'Group entries under a CustomDropdownLabel, and use checkbox '
