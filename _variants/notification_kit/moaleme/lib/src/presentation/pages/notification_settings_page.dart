  ...
  void _showSoundSelectionDialog(
    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) {
        // Pick a sound, preview it, persist it, then close.
        Future<void> select(String? sound, String asset) async {
          await player.play(AssetSource(asset));
          notifier.updateCustomSound(sound);
        ...
        return RadioGroup<String?>(
          ...
          onChanged: (val) {
            switch (val) {
              case null:
                select(null, 'sounds/notification_default.mp3');
              case 'notification_sound_1':
                select('notification_sound_1', 'sounds/notification_sound_1.wav');
              case 'notification_sound_2':
                select('notification_sound_2', 'sounds/notification_sound_2.wav');
            }
          },
          child: Column(
            ...
            children: [
              ListTile(
                ...
                onTap: () => select(null, 'sounds/notification_default.mp3'),
              ),
              ListTile(
                title: const Text('Success Tone'),
                leading: const Radio<String?>(value: 'notification_sound_1'),
                onTap: () => select(
                  'notification_sound_1',
                  'sounds/notification_sound_1.wav',
                ),
              ),
              ListTile(
                title: const Text('Bubble Pop'),
                leading: const Radio<String?>(value: 'notification_sound_2'),
                onTap: () => select(
                  'notification_sound_2',
                  'sounds/notification_sound_2.wav',
                ),
              ),
            ],
          ),
