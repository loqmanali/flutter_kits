...
class NotificationPayloadParser {
  ...
  static NotificationPayload? parse(Map<String, dynamic> data) {
    try {
      ...
      debugPrint('[NotificationPayloadParser] Parsing data: $data');
      ...
      if (data.containsKey('type')) {
        debugPrint('[NotificationPayloadParser] Found flat payload with type');
      ...
      // In debug mode, you might want to print the error
      if (true) {
        // NotificationConfig.debugMode
