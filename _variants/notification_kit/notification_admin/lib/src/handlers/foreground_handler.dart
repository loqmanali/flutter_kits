  ...
  Future<void> _handleNotification(
    ...
    try {
      ...
      NotificationKitRuntime.logger.warning(
        '[ForegroundHandler] Error reading notification settings',
        e,
        stackTrace,
      );
    ...
    if (context == null ||
      ...
      NotificationKitRuntime.logger.debug(
        '[ForegroundHandler] Skipping toast - context not ready',
      );
      ...
      try {
        ...
        NotificationKitRuntime.logger.error(
          '[ForegroundHandler] Failed to show fallback notification',
          e,
          stackTrace,
        );
      }
    ...
    try {
      ...
      NotificationKitRuntime.logger.error(
        '[ForegroundHandler] Toast notification failed',
        e,
        stackTrace,
      );
