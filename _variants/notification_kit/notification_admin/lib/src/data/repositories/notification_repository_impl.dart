  ...
  Future<Either<NotificationFailure, void>> showNotification(
    ...
    try {
      ...
      try {
        ...
        NotificationKitRuntime.logger.debug('[NotificationRepository] Settings JSON: $settingsJson');
        ...
        NotificationKitRuntime.logger.warning(
          '[NotificationRepository] Failed to check notification settings',
          e,
          stackTrace,
        );
      }
      ...
      try {
        ...
        NotificationKitRuntime.logger.warning(
          '[NotificationRepository] Failed to get sound/vibration settings, using default',
          e,
          stackTrace,
        );
      }
      ...
      NotificationKitRuntime.logger.error(
        '[NotificationRepository] Failed to show local notification',
        e,
        stackTrace,
      );
      return Left(
