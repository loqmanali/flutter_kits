...
void main() {
  group('CustomStarRating', () {
    ...
    testWidgets('tapping a star reports that star\'s index+1 rating', (tester) async {
      double? reported;
      await tester.pumpWidget(
        _wrap(
          CustomStarRating(
    ...
    testWidgets('readOnly ignores taps and never fires the callback', (tester) async {
      var fired = 0;
      await tester.pumpWidget(
        _wrap(
          CustomStarRating(
    ...
    testWidgets('does not re-fire when the tapped rating equals the current one',
        (tester) async {
      var fired = 0;
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('clamps an over-range initialRating to starCount', (tester) async {
