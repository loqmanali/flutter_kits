...
class SlotPickerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      ...
      intro: 'Pick a date and a time slot, inline or in a bottom sheet. Three '
...
class _InlineDateTimeDemoState extends State<_InlineDateTimeDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description: 'A day strip plus a time-slot grid. onDaySelected is an async '
...
class _TimeOnlyDemoState extends State<_TimeOnlyDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    return DemoSection(
      ...
      description: 'Skip the date strip and just show slots from initialSlots — '
