...
class ThemePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GalleryScaffold(
      title: 'Theme & Tokens',
      intro: 'WidgetKitTokens are fixed design constants; WidgetKitTheme is a '
...
WidgetKitTokens.buttonHeight // 48''',
        ...
        DemoSection(
          ...
          description: 'WidgetKitTokens.radius* — corner radii from xs to pill.',
          demoBackground: false,
          demo: Wrap(
            spacing: 12,
            runSpacing: 12,
        ...
        DemoSection(
          ...
          description: 'Widgets resolve their look from the registered '
