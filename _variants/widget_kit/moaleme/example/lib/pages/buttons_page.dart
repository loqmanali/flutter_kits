...
class ButtonsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Buttons',
      intro: 'AppButton is one adaptive button covering ten Material styles, '
            ...
            DemoSection(
              ...
              demo: const Wrap(
                ...
                children: [
                  ...
                  AppButton(
                      label: 'Tonal', style: AppButtonStyleType.filledTonal),
                  AppButton(
                      label: 'Elevated', style: AppButtonStyleType.elevated),
                  AppButton(
                      label: 'Outlined', style: AppButtonStyleType.outlined),
  ...
  onPressed: () {},
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              title: 'Three sizes',
              description: 'large / medium / small adjust height, padding and '
                  'font size together.',
              demo: const Column(
              ...
              code: "AppButton(label: 'Medium', size: AdaptiveButtonSize.medium)",
            ),
            DemoSection(
              title: 'Label + icon',
              description: 'Add a leading or trailing icon alongside the label.',
              demo: const Wrap(
                spacing: 10,
                children: [
...
AppButton(label: 'Disabled', isDisabled: true)''',
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              title: 'AppButton.fab',
              description: 'A FAB constructor with regular, small, large and '
                  'extended types.',
              demo: Wrap(
                spacing: 14,
  ...
  onPressed: () {},
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              title: 'AppBackButton',
              description: 'A circular, shadowed back affordance for custom '
                  'top bars.',
