...
void main() {
  ...
  group('WidgetKitTheme resolves through a real app', () {
    testWidgets('of() returns the registered extension', (tester) async {
      ...
      await tester.pumpWidget(
        _app(
          extensions: const [WidgetKitTheme(inputBorderRadius: 18, buttonHeight: 60)],
          home: Builder(
            builder: (context) {
    ...
    testWidgets('of() falls back when no extension is registered', (tester) async {
      late WidgetKitTheme resolved;
      await tester.pumpWidget(
        _app(
          home: Builder(
  ...
  group('AppButton in a full app', () {
    testWidgets('renders and fires onPressed', (tester) async {
      ...
      await tester.pumpWidget(
        _app(
          home: Scaffold(
            body: Center(child: AppButton(label: 'Go', onPressed: () => pressed++)),
          ),
        ),
      );
  ...
  group('Slot/time picker — real async day-load flow', () {
    ...
    testWidgets('dateAndTime mode: shows the choose-date prompt then the day strip',
        (tester) async {
      await tester.pumpWidget(
        _app(
          home: Scaffold(
