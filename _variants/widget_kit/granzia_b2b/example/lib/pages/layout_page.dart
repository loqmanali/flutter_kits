...
class LayoutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Layout',
      intro: 'Structural building blocks: expandable panels, spacing, top bars '
          'and a ready-made profile scaffold.',
      sections: [
        DemoSection(
          title: 'Accordion',
          description: 'Expandable panels. Set allowMultipleOpen to keep more '
...
Accordion(
  ...
  items: [
    AccordionItemData(header: Text('Title'), content: Text('Body')),
        ...
        DemoSection(
          title: 'AppSpacing',
          description: 'Declarative gaps: height, width, flex, plus small / '
              'medium / large presets.',
          demoBackground: false,
          demo: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              _spacerRow(context, 'AppSpacing.height(8)', const AppSpacing.height(8)),
              _spacerRow(context, 'AppSpacing.height(24)', const AppSpacing.height(24)),
            ],
          ),
          code: '''
...
AppSpacing.medium             // preset = height(16)''',
        ...
        DemoSection(
          title: 'PageTopBar',
          description: 'A lightweight custom app-bar row: back affordance, '
...
PageTopBar(
  ...
  actions: [IconButton(icon: Icon(Icons.edit), onPressed: _edit)],
        ...
        DemoSection(
          ...
          description: 'A full page scaffold (top bar + safe-area body) for '
                ...
                MaterialPageRoute<void>(
                  builder: (_) => ProfilePageLayout(
                    ...
                    child: ListView(
                      children: const [
                        ListTile(
                            leading: Icon(Icons.person), title: Text('Account')),
                        ListTile(
                            leading: Icon(Icons.lock), title: Text('Security')),
                        ListTile(
