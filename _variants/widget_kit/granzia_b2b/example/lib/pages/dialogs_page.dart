...
class DialogsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      ...
      intro: 'Modal surfaces and transient messages. Toasts require a '
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              ...
              description: 'A confirm/cancel dialog for destructive or important '
...
showDialog(
  ...
  builder: (_) => AppWarningDialog(
    ...
    onPressed: _delete,
            ...
            DemoSection(
              title: 'DialogPicker',
              description: 'A rounded dialog container that hosts any child — a '
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              ...
              description: 'A modal bottom sheet, topped with the standard '
        ...
        DemoGroup(
          ...
          children: [
            DemoSection(
              ...
              description: 'Transient, non-blocking messages. Pick a type for '
