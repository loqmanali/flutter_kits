...
class InputsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Inputs',
      intro: 'Form inputs that pick up colours, radii and fonts from '
          'WidgetKitTheme, with per-field overrides.',
      sections: const [
        DemoSection(
          title: 'AppTextFormField',
          description: 'A themed TextFormField wrapper with label, hint and '
...
class _PhoneFieldDemoState extends State<_PhoneFieldDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description: 'International phone input with a country picker and a typed '
...
class _DobPickerDemoState extends State<_DobPickerDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description: 'showDobPicker opens a scroll-wheel bottom sheet and returns '
