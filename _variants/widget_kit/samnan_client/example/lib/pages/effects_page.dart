...
class EffectsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GalleryScaffold(
      title: 'Effects',
      intro: 'Interactive and animated flourishes: a star rating, a custom '
          'pull-to-refresh, and an animated traveling border.',
      sections: const [
        _StarRatingDemo(),
        DemoSection(
          title: 'TravelingBorderWidget',
          description: 'An animated gradient border that travels around the '
...
class _StarRatingDemoState extends State<_StarRatingDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description: 'Tap (or drag for half-stars) to rate. Set readOnly to use '
...
class _RefreshTriggerDemoState extends State<_RefreshTriggerDemo> {
  ...
  Widget build(BuildContext context) {
    return DemoSection(
      ...
      description: 'A customisable pull-to-refresh. Pull the list down to fire '
          'onRefresh.',
      demo: SizedBox(
        height: 220,
        child: ClipRRect(
