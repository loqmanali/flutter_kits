...
class MonthDayPicker extends StatelessWidget {
  ...
  bool get _isRtl => _isRtlLocale(locale);

  /// `DateTime.saturday` (6) for RTL, `DateTime.sunday` (7) otherwise.
  int get _firstWeekday => _isRtl ? DateTime.saturday : DateTime.sunday;
  ...
  Widget _weekdayHeader() {
    ...
    final style =
        theme.dayNameStyle?.copyWith(color: theme.grey500) ??
        TextStyle(
          color: theme.grey500,
    ...
    final cells = <Widget>[
      ...
      for (final day in days)
        _DayCell(
          ...
          isSelected:
              selectedDate != null &&
              _dateOnly(day).isAtSameMomentAs(selectedDate!),
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected =
              ...
              _dateOnly(day).isAtSameMomentAs(widget.selectedDate!);
