...
class DayTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayDayName = isRtl
        ? dayName
        : dayName.substring(0, 3).toUpperCase();
    final dayNumber = date.day.toString().padLeft(2, '0');
    final displayDayNumber = isRtl ? _toArabicNumerals(dayNumber) : dayNumber;
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style:
                      theme.dayNameStyle?.copyWith(color: nameColor) ??
                      TextStyle(
                        color: nameColor,
                ...
                Text(
                  displayDayNumber,
                  style:
                      theme.dayNumberStyle?.copyWith(color: numberColor) ??
                      TextStyle(
                        color: numberColor,
