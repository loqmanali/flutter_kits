...
class _AppButtonState extends State<AppButton> {
  ...
  ButtonStyle get _buttonStyle {
    ...
    return ButtonStyle(
      ...
      padding: WidgetStateProperty.all(widget.customPadding ?? size.padding),
      ...
      textStyle: WidgetStateProperty.all(
        widget.textStyle ??
            TextStyle(fontSize: size.fontSize, fontWeight: size.fontWeight),
      ),
  ...
  Widget _buildLabelWithIcon() {
    ...
    final text = widget.fitLabel
        ? FittedBox(fit: BoxFit.scaleDown, child: baseText)
        : baseText;
