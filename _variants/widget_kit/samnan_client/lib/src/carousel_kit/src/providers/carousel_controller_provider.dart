...
class CarouselController extends ChangeNotifier {
  ...
  void animateToPage(int index) {
    ...
    _pageController!
        ...
        .then((_) {
          _state = _state.copyWith(currentIndex: index, isAnimating: false);
...
final carouselControllerProvider = Provider.autoDispose
    .family<CarouselController, List<CarouselItem>>(
