...
void main() {
  ...
  group('PageTopBar', () {
    testWidgets('renders the title', (tester) async {
      await tester.pumpWidget(_wrap(const PageTopBar(title: 'Settings')));
    ...
    testWidgets('fires onBackPressed when the back affordance is tapped', (
      ...
      var back = 0;
      await tester.pumpWidget(
        _wrap(PageTopBar(title: 'Detail', onBackPressed: () => back++)),
      );
  ...
  group('LoadingIndicator', () {
    ...
    testWidgets('renders without error for the adaptive type', (tester) async {
      await tester.pumpWidget(
        _wrap(
          const Center(
            child: LoadingIndicator(type: LoadingIndicatorType.adaptive),
          ),
        ),
      );
