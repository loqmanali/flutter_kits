...
void main() {
  ...
  group('phoneNumberValidator', () {
    ...
    test('disableLengthCheck skips the length rule', () {
      final error = phoneNumberValidator('12', egypt, disableLengthCheck: true);
      expect(error, isNull);
    });
  ...
  group('customPhoneNumberValidator', () {
    ...
    test(
      'returns the custom validator result when it yields a String',
      () async {
    ...
    test(
      'passes a PhoneNumber built from the value to the validator',
      () async {
        PhoneNumber? received;
        await customPhoneNumberValidator('1001234567', egypt, (phone) {
          received = phone;
          return null;
        });
    ...
    test('supports async custom validators', () async {
      final result = await customPhoneNumberValidator('1', egypt, (
        phone,
      ) async {
