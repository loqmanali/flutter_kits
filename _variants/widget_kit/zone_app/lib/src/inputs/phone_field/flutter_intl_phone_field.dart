...
import 'country_flag_button.dart';
...
class IntlPhoneField extends StatefulWidget {
  ...
  /// Message to display when the phone field is empty. Default
  /// `Phone number is required`.
  final String phoneNumberRequiredText;
  ...
  /// Whether to show the country selection dialog when the country selector is tapped.
  /// If false, the country selector will be disabled and won't show the dialog.
  /// Default is true.
  ...
  const IntlPhoneField({
    ...
    this.phoneNumberRequiredText = 'Phone number is required',
    this.cursorHeight,
