...
class OTPController extends StateNotifier<OTPState> {
  ...
  void updateDigit(int index, String value) {
    ...
    // Check if complete
    final isComplete = newValue.length == config.length;
...
///
/// This is a family provider that creates a controller for each unique config.
/// Multiple OTP fields with the same config will share the same controller instance.
///
/// Example:
/// ```dart
/// final controller = ref.watch(otpControllerProvider(myConfig));
/// ```
final otpControllerProvider = StateNotifierProvider.family<
    OTPController,
    OTPState,
    OTPConfig>((ref, config) {
...
/// ```
final otpValueProvider = Provider.family<String, OTPConfig>((ref, config) {
...
/// ```
final otpIsCompleteProvider = Provider.family<bool, OTPConfig>((ref, config) {
  return ref.watch(
...
/// ```
final otpHasErrorProvider = Provider.family<bool, OTPConfig>((ref, config) {
  return ref
...
final otpErrorMessageProvider =
    Provider.family<String?, OTPConfig>((ref, config) {
  return ref.watch(
...
/// ```
final otpProgressProvider = Provider.family<double, OTPConfig>((ref, config) {
  return ref
