...
/// Logger contract used internally by firebase_kit.
///
/// The host app can plug in its own logger (e.g. AppLogger, Sentry, the
/// `logger` package, etc.) via [FirebaseKitRuntime.use]. If none is provided,
/// [DeveloperFirebaseLogger] is used as a sensible default.
abstract class FirebaseLogger {
...
class DeveloperFirebaseLogger implements FirebaseLogger {
  const DeveloperFirebaseLogger();

  static const String _name = 'FirebaseKit';
